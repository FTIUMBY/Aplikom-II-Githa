...
<head>
  ...
  <tr>
    ...
    <td width="169" bgcolor="#FFFFFF">
      <label>
      <div align="center"><a href="cetak_kelas.php?id_kelas=<?php echo $i_kelas;?>" target="_blank" "javascript:window.print()">CETAK</a><span class="style1"></a></div>
      </label></td>
    <tr>
    <td colspan="2">
