...
<fieldset>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'NPSN',array('maxlength'=>10)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'NIK',array('maxlength'=>21)); ?>
...
<fieldset>
	<h3><?php echo Yii::t('attribute', 'Keterangan Pribadi');?></h3>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'nama'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'nama',array('maxlength'=>64)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'panggilan',array('maxlength'=>32)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'tempat_lahir',array('maxlength'=>64)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'kewarganegaraan_pegawai',array('maxlength'=>3)); ?>
...
<fieldset>
	<h3><?php echo Yii::t('attribute', 'Keterangan Tempat Tinggal');?></h3>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'no_telp',array('maxlength'=>15)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'tinggal_dengan',array('maxlength'=>64)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'jarak',array('maxlength'=>2)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'transportasi',array('maxlength'=>32)); ?>
...
<fieldset>
	<h3><?php echo Yii::t('attribute', 'Keterangan Kesehatan');?></h3>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'gol_darah'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'gol_darah',array('maxlength'=>1)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'tinggi',array('maxlength'=>3)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'berat',array('maxlength'=>3)); ?>
