...
class PegawaiController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = Pegawai::model()->findByPk(1,array(
		...
		$this->pageTitle = Yii::t('phrase', 'Pegawais');
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Pegawais');
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Pegawais Manage');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['Pegawai'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'id' => 'partial-pegawai',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Pegawai success created.').'</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'Pegawai success created.'));
		...
		$this->pageTitle = Yii::t('phrase', 'Create Pegawais');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['Pegawai'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'get' => Yii::app()->controller->createUrl('manage'),
							'id' => 'partial-pegawai',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Pegawai success updated.').'</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'Pegawai success updated.'));
					//$this->redirect(array('view','id'=>$model->pegawai_id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = Yii::t('phrase', 'Update Pegawais');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				...
				Pegawai::model()->deleteAll($criteria);
			}
		}
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				if($model->delete()) {
					echo CJSON::encode(array(
						...
						'get' => Yii::app()->controller->createUrl('manage'),
						'id' => 'partial-pegawai',
						'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Pegawai success deleted.').'</strong></div>',
					));
				}
			}
			...
			$this->pageTitle = Yii::t('phrase', 'Pegawai Delete.');
			$this->pageDescription = '';
			$this->pageMeta = '';
