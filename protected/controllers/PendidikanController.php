...
class PendidikanController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = Pendidikan::model()->findByPk(1,array(
		...
		$this->pageTitle = Yii::t('phrase', 'Pendidikans');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['Pendidikan'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'Pendidikan success created.'));
					//$this->redirect(array('view','id'=>$model->pendidikan_id));
					$this->redirect(array('manage'));
				}
			}
		}
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['Pendidikan'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'Pendidikan success updated.'));
					//$this->redirect(array('view','id'=>$model->pendidikan_id));
					$this->redirect(array('manage'));
				}
			}
