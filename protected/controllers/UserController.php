...
class UserController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = User::model()->findByPk(1,array(
		...
		$this->pageTitle = Yii::t('phrase', 'Users');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['User'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'User success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['User'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'User success updated.'));
					//$this->redirect(array('view','id'=>$model->user_id));
					$this->redirect(array('manage'));
				}
			}
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageTitle = Yii::t('phrase', 'User Delete.');
			$this->pageDescription = '';
			$this->pageMeta = '';
