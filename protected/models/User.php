 ...
 * @created date 20 February 2017, 11:55 WIB
...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('status, level_id, username, user_password, displayname, creation_date, creation_id, modified_id', 'required'),
			...
			array('user_id, status, level_id, username, user_password, displayname, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'level_relation' => array(self::BELONGS_TO, 'TblUserLevel', 'level_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'user_password' => Yii::t('attribute', 'User Password'),
	...
	public function search()
	{
		...
		$criteria->compare('t.user_password',strtolower($this->user_password),true);
	...
	public function getGridColumn($columns=null) {
		if($columns !== null) {
			...
			$this->defaultColumns[] = 'user_password';
